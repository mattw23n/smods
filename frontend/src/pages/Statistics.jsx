...
function Graph({ data }) {
    ...
    return (
        <div className="flex flex-col items-center justify-start">
            <div className="bg-white/50 rounded-3xl p-8 text-justify max-w-screen w-4/5 mb-12">
                <p className="font-poppins font-bold text-lg mb-4">These are the percentages of the bidders</p>
                <div className="flex flex-col gap-4">
                ...
                <p className="font-poppins font-bold text-lg my-4">{highestBidModule} is the highest bidded mod</p>
            </div>
        </div>
    );
}
