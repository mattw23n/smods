        ...
        <div className="flex-grow mt-20">
            ...
            <div className={`${isEditMode ? `px-20 mb-10 flex gap-5`: "px-20 mb-10"}`}>
                ...
                {!isGroupView && (
                    ...
                    {/* <div>
                        <Year key={1} num={1} plan={plan} mods={mods} setMods={setMods} />
                    </div>
                    <div className="mt-20">
                        
                        <Year key={2} num={2} plan={plan} mods={mods} setMods={setMods} />
                    </div> */}
...
function Anims(){
    ...
    return(
        <div className="relative flex flex-col min-h-screen bg-blue-200">
            {/* <Background/> */}
