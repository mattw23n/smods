                        ...
                        <div className="bg-white bg-opacity-25 rounded-xl p-8 shadow-md max-w-screen w-4/5 flex flex-col items-center justify-between">
                            ...
                            <div className="flex flex-row w-full font-poppins">
                                <div className="flex flex-col bg-white bg-opacity-40 p-8 rounded-xl w-3/4 items-center justify-center">
                                    ...
                                    <input type="name" placeholder="Enter Your name" style={{ fontSize: '14px' }} className="appearance-none w-full text-gray-700 mb-2 px-2 py-1 leading-tight focus:outline-none" />
                                    <p className="font-bold ml-2 mt-2 mb-1 text-sm" style={{ alignSelf: 'start' }}>Email</p>
                                    <input type="mail" placeholder="Enter your email" style={{ fontSize: '14px' }} className="appearance-none w-full text-gray-700 mb-2 px-2 py-1 leading-tight focus:outline-none" />
                                    <p className="font-bold ml-2 mt-2 mb-1 text-sm" style={{ alignSelf: 'start' }}>Message</p>
                                    <textarea id="message" rows="4" className="block p-2.5 w-full text-sm text-gray-900 mb-4 border-none focus:ring-transparent" placeholder="Your message..."></textarea>
                                    <div className="flex justify-end w-full">
                                        <button className="w-1/5 bg-black text-white py-1 rounded-lg">Send</button>
                                    </div>
                                </div>
