...
import cap from "../images/smods-cap.png";
import emptyUser from "../images/empty-user.png";
            ...
            <div className="flex h-16 items-center justify-between">    
                ...
                <div className="md:flex md:items-center md:gap-12">
                    ...
                    <ul className="flex items-center gap-6 text-sm text-text">
                        <NavItem title={"Summary"} link={"#"}></NavItem>
                        <NavItem title={"About Us"} link={"#"}></NavItem>
                        <NavItem title={"Contact Us"} link={"#"}></NavItem>
                    </ul>
                    </nav>
