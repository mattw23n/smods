...
const Mod = ({ module, plan, handleDragStart, mods, setMods, setValidationResponse }) => {
    ...
    const updateModule = async (updatedModule) => {
        try {
            ...
            const response = await fetch(`http://52.221.189.77:8080/api/users/${plan.userId}/plans/${plan.planId}/update-module-gpa?moduleId=${updatedModule.moduleId}&term=${updatedModule.term}&gpa=${updatedModule.GPA}`, {
                method: 'PUT',
                headers: {
